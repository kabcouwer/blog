                ...
                <Link href={demo} target="_blank" rel="noopener noreferrer">
                  <button
                    className={
                      isHidden
                        ? "hidden"
                        : "transform mouse-pointer bg-gray-900 text-sm text-white mr-2 py-1 px-2 font-semibold rounded hover:bg-gray-700 dark:hover:bg-gray-600 hover:scale-90 focus:bg-gray-700 dark:focus:bg-gray-600 focus:outline-none"
                    }
                  >
                    Live
                  </button>
